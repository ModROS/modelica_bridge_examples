 ...
 * @file controller.cpp
 * 
 * Receives teleop input from two_springs_modbridgex_teleop, and feedback from model via modbridge_node.
...
{
    ros::init(argc, argv, "two_springs_modbridgex_controller");
    ros::NodeHandle n;
